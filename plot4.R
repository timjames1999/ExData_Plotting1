...
#Plot All 4 graphs in a 2x2 .png
png("plot4.png", width=480, height=480)
par(mfrow = c(2,2))

plot(comb_time, subsetdata[, 3], xlab = "", ylab = "Global Active Power (kilowatts)", type = "l")

plot(comb_time, subsetdata[, 5], xlab = "datetime", ylab = "Voltage", type = "l")
...
plot(comb_time, subsetdata[, 4], xlab = "datetime", ylab = "Global_reactive_power", type = "l")
